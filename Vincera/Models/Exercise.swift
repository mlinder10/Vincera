...
final class Exercise: Codable, Identifiable, Hashable {
  ...
  func clone() -> Exercise {
    return Exercise(id: UUID().uuidString, listId: listId, rpe: rpe, unitOne: unitOne, unitTwo: unitTwo, sets: sets.map { $0.clone() })
  }
  ...
  func maxValue(for unit: ExerciseUnit) -> Double? {
