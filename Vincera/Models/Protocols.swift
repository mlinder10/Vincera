...
extension VinceraSet {
  enum CodingKeys: String, CodingKey {
    case _id = "id"
    case _valueOne = "valueOne"
    case _valueTwo = "valueTwo"
    case _type = "type"
  }
...
extension ListExercise {
  enum CodingKeys: String, CodingKey {
    ...
    case _cues = "cues"
    case _image = "image"
    case _videoId = "videoId"
    case _bodyPart = "bodyPart"
    case _primaryGroup = "primaryGroup"
    case _secondaryGroups = "secondaryGroups"
    case _exerciseType = "exerciseType"
    case _equipmentType = "equipmentType"
    case _repsLow = "repsLow"
    case _repsHigh = "repsHigh"
  }
  
  static func == (lhs: ListExercise, rhs: ListExercise) -> Bool {
    lhs.id == rhs.id
  }
